...
if (!class_exists('MRKV_UA_SHIPPING_NOVA_GLOBAL'))
{
    /**
     * Class for setup rozetka delivery method
     */
    class MRKV_UA_SHIPPING_NOVA_GLOBAL extends WC_Shipping_Method
    {
        public function __construct($instance_id = 0)
        {
            ...
            # Set main fields
            $this->id = 'mrkv_ua_shipping_nova-global';
            $this->method_title = __( 'Nova Global', 'mrkv-ua-shipping' );
        ...
        public function init_form_fields()
        {
            $this->instance_form_fields = array(
                'title' => array(
                    ...
                    'type' => 'text',
                    'description' => '',
                    'default' => __('Nova Global', 'mrkv-ua-shipping')
                ),
                'warehouse_type' => array(
                    'title'       => __('Warehouse type', 'mrkv-ua-shipping'),
                    'type'        => 'select',
                    'description' => '',
                    'default'     => 'Cargo depot',
                    'options'     => array(
                        'Cargo depot' => __('Cargo depot', 'mrkv-ua-shipping'),
                        'Parcel depot'  => __('Parcel depot', 'mrkv-ua-shipping'),
                        'Poshtomat'  => __('Poshtomat', 'mrkv-ua-shipping'),
                        'Parcel shop'  => __('Parcel shop', 'mrkv-ua-shipping')
                    ),
                ),
                'shipping_type' => array(
                ...
                'free_shipping_text' => array(
                    ...
                    'type' => 'text',
                    'placeholder' => __('FREE to Nova Global', 'mrkv-ua-shipping'),
                    'description' => '',
                ),
